...
/*
* Hilfsmittel: https://www.youtube.com/watch?v=0QqAkopW31M
*
*/
            ...
            public void onClick(View view) {
                ...
                user.signUpInBackground(new SignUpCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e != null) {
                            Log.e(TAG, "create of user unsuccessful",e);
                            Toast.makeText(SignupActivity.this, "Login is unsuccessful", Toast.LENGTH_LONG).show();
                            return;

                        } else {
                            Log.i(TAG, " Success on Sign up!");
                            Toast.makeText(SignupActivity.this, "Login is Successful", Toast.LENGTH_LONG).show();
                            goMainActivity();
                        }
                    }
                });
